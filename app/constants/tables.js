...
export const ALL_COUNTRY_COLUMNS = {
  ...
  triggerSuitability: ['site_id', 'csn_name', 'population_name', 'species', 'current_suitability',
...
export const DEFAULT_COUNTRY_COLUMNS = {
  ...
  populations: ['scientific_name', 'english_name', 'iucn_category', 'population', 'a', 'b', 'c', 'ramsar_criterion', 'size_method', 'trend_method',],
  ...
  triggerSuitability: ['csn_name', 'population_name', 'species', 'current_suitability',
    'future_suitability', 'change_suitability', 'threshold', 'season_ev'],
...
export const ALL_SPECIES_COLUMNS = {
  ...
  populationThreats: ['pop_id', 'threat_id', 'population', 'threat_code', 'threat_label', 
    'description', 'scope', 'severity'],
